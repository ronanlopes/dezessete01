...
class TF_THEME_DOWNLOAD extends Theme_Upgrader {
    ...
    public  $theme_name             = 'GamesZone';
    public  $theme_prefix           = 'gameszone';
    public  $new_theme_prefix       = 'gameszone-parent'; // directory name of the new installed theme
    public  $new_theme_prefix_child = 'gameszone-child';
    public  $theme_license          = 'b25383deaa0c2d4ada507490f564fc82';
    private $check_url              = 'http://themefuse.com/update-themes/';
    public  $downloader_prefix      = 'tfuse-download-gameszone'; // directory name, will be used for autodeletion
