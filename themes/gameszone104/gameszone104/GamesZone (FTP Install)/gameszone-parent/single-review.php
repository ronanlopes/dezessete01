            ...
            <?php if(!empty($video_link)):?>
                <div class="top-video">
                    ...
                    <?php 
                        ...
                        if(!empty($video_id)) 
                            echo  '<iframe id="player" src="http://www.youtube.com/embed/'.$video_id[0].'?enablejsapi=1" width="782" height="440" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>';
                        elseif ($pos2!='')
