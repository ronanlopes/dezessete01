                        ...
                        <?php if(!empty($slide['slide_video'])):?>
                            <?php 
                                if ( !empty($slide['slide_video'])) :
                                    ...
                                    if(!empty($video_id)) 
                                    echo  '<iframe src="http://www.youtube.com/embed/'.$video_id[0].'?wmode=transparent" width="782" height="440" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>';
