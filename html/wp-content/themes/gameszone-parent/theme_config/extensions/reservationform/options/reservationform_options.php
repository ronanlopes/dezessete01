                ...
                array(
                    ...
                    'options' => array(
                        ...
                        array('name' => __('User reservation title','tfuse'),
                            ...
                            'id' => 'tf_rf_res_title',
                            'value' => __('New reservation','tfuse'),
                            'type' => 'text'),
                    )
                ),
                array(
                ...
                array(
                    ...
                    'options' => array(
                        ...
                        array('name' => __('Reservation notice','tfuse'),
                            ...
                            'value' => __('Please note that this is not an actual appointment, but only a request for one. We will contact you for a confirmation shortly after. Thank you! By clicking the "Make an Appointment" button you agree to the Terms & Conditions below.','tfuse'),
                            'type' => 'textarea'),

                        array('name' => __('Success message','tfuse'),
                            'desc' => __('This message will be displayed if the form is successfully submitted','tfuse'),
                            'id' => 'tf_rf_succ_mess',
                            'value' => __('Reservation successfully sent. We\'ll get back to you shortly.','tfuse'),
                            'type' => 'text'),
                        array('name' => __('Failure message','tfuse'),
                            ...
                            'value' => __('Oops something went wrong. Please try again later','tfuse'),
                            'type' => 'text'),
                        ...
                        array('name' => __('Email subject','tfuse'),
                            'desc' => __('This text will appear in the Subject line when the users receive a confirmation, approval or rejection email. Use the ','tfuse').'<strong>[resnumber]</strong>'.__(' shortcode to include the reservation number in the subject line.','tfuse'),
                            'id' => 'tf_rf_email_subject',
                            'value' => __('Your reservation number is ','tfuse').'[resnumber]',
                            'type' => 'text'),
                        array('name' =>__('New reservation admin email template','tfuse') ,
                            ...
                            'value' => __('Your reservation ','tfuse').'[resnumber]'.__('has entered in our system and one of our guys will process it in a short while.<br>You will receive an email if the reservation is approved or denied shortly.<br><br>For further inquires please reply to this email','tfuse') ,
                            'type' => 'textarea'),
                        array('name' => __('Reservation approved email template','tfuse'),
                            ...
                            'value' => __('Your reservation ','tfuse').'[resnumber]'.__('Your reservation ','tfuse').'[checkin].<br><br>'.__('For further assistance please reply to this email.','tfuse'),
                            'type' => 'textarea'),
                        array('name' => __('Reservation rejected email template','tfuse'),
                            ...
                            'value' => __('Your reservation ','tfuse').'[resnumber]'.__('was rejected. ','tfuse').'<br><br>'.__('For further assistance please reply to this email.','tfuse'),
                            'type' => 'textarea'),
                        array('name' => __('Reservation confirmation email template','tfuse'),
                            'desc' => __('This email is automatically sent when a user makes a reservation. This is not an Approval or Rejection email but only a confirmation that the reservation is registered in the system with a certain unique number for easy identification which can also be attached to the email with the ','tfuse').'<strong>[resnumber]</strong>'.__(' shortcode.','tfuse'),
