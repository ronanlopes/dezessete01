                ...
                array(
                    ...
                    'options' => array(
                        array(
                            ...
                            'value' => 'game',
                            'options' => array('game' => __('Games Categories','tfuse') , 'review' => __('Reviews Categories','tfuse'),'post' => __('Categories','tfuse')),
                            'type' => 'select'
                        ),
                        array(
                ...
                array(
                    ...
                    'options' => array(
                        array(
                            ...
                            'id' => 'sliders_posts_from',
                            'value' => 'game',
                            'options' => array('game' => __('Games','tfuse') , 'review' => __('Reviews','tfuse'),'post' => __('Posts','tfuse')),
                            'type' => 'select'
                        ),
                        array(
