...
$cfg['setup'] = array(
    ...
    array(
        'design' => 'carousel_medium',
        'name' => __('Carousel Medium Slider', 'tfuse')
    ),
    array(
        'design' => 'video',
        'name' => __('Video Slider', 'tfuse')
    ),
    array(
        'design' => 'content',
        'name' => __('Content Slider', 'tfuse')
    ),
    array(
        'design' => 'home',
                ...
                array(
                    ...
                    'options' => array(
                        array(
                            ...
                            'desc' => __('Choose the slider type. You can check the sliders in the ','tfuse').'<a target="_black" href="//themefuse.com/demo/wp/medica/">'.__('demo live preview','tfuse').'</a>'.__(' on our website.','tfuse'),
