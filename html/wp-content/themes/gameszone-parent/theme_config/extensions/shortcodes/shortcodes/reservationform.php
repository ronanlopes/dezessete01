...
function tf_reservationform_shortcode($atts){
    ...
    if($form_exists){
        ...
        $out .='<div class="tf-form contact-form">';
        ...
        $out.='<div class="clear"></div><div class="row_form row_submit clearfix">';
        $out.='<button id="sending" class="btn btn-main btn-send2" style="display: none;"><span class="icon icon-plus-sign"></span>'.__('Sending ...','tfuse').'</button>
             <button type="submit" id="send_reservation" class="btn btn-main btn-submit2" name="submit" ><span class="icon icon-plus-sign"></span>'. urldecode($form['submit_mess']).'</button>
        ...
        $out.='<div class="clear"></div><div class="reservation_notice">'.urldecode($form['tf_rf_form_notice']).'</div>';
    }
    else {
...
function res_textarea($input,$form_input){
    return "<div class='clear'></div><div class='row_form field_textarea ".$form_input['classes']."' style='".$form_input['floating']."'>
                <label class='label_title' for='" .TF_THEME_PREFIX.'_'.trim($form_input['shortcode']). "'><strong>".__($form_input['label_text'],'tfuse')."</strong></label>
...
function res_datepicker($input,$form_input){
    ...
    $output="<div class='row_form alignleft field_text ".$form_input['classes']."' style='".$form_input['floating']."'>
                 <label class='label_title' for='" .TF_THEME_PREFIX.'_'.trim($form_input['shortcode']). "'><strong>".__($form_input['label_text'],'tfuse')."</strong></label>
                <input style='width:".($form_input['ewidthpx'])."px;' type='text' class='".$input['properties']['class']."' name='".TF_THEME_PREFIX.'_'. trim($form_input['shortcode'])."' placeholder='".$form_input['label_text']."'/></div>";
    return $output;
}
...
function res_captcha($input,$form_input){
    ...
    $out="<div class='row_form alignleft field_text' style='width:".$form_input['width']."%;".$form_input['floating']."'>
            <label class='label_title' for='" .TF_THEME_PREFIX.'_'.trim($form_input['shortcode']). "'><strong>".__($form_input['label_text'],'tfuse')."</strong></label>
...
function res_select($input,$form_input){
    ...
    $out = "<div class='row_form field_select alignleft ".$form_input['classes']."'  >
                <label class='label_title' for='" .TF_THEME_PREFIX."_".trim($form_input['shortcode']). "'>".__($form_input['label_text'],'tfuse')."</label>
