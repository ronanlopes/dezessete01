        ...
        <h3 class="widget-title">' . $title . '</h3> 
                ...
                <form action="#" method="post" class="newsletter_subscription_form">
                    <div class="newsletter_text">'.$text.'</div>
                        <input type="text" value="" name="newsletter" id="newsletter" class="newsletter_subscription_email inputtext" placeholder="'. __('Your Email', 'tfuse').'"/>
                        <button type="submit" value="'. __('Send','tfuse') .'" class="btn btn-main newsletter_subscription_submit">'.__('Subscribe','tfuse').'</button>
