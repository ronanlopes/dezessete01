...
if ( !function_exists('tfuse_review_cat_links')):
    function tfuse_review_cat_links($post_id){
        ...
        if(!empty($terms_platforms) || !empty($terms_genres))
        {
            ...
            echo ', <a href="' . home_url('/') . '?s=~&price-range=0%3B10&tax_reviews= '.$platforms_link.$genres_link.'">'.$count .' '.__('More','tfuse').'</a>';
        }
    }
endif;
    ...
    function tfuse_get_game_news( $post_id ) {
        ...
        if ( ! empty( $posts ) ) {
            foreach ( $posts as $post ) {
                $games_posts = explode( ',', tfuse_page_options( 'game_select', '', $post ) );
    ...
    function tfuse_get_slides_from_posts( $posts=array(), $slider = array() )
    {
        ...
        foreach ($posts as $k => $post) : $k++;
            ...
            elseif($slider['design'] == 'video'){
	            ...
	            $tfuse_image = $thumbnail
		            ? ' <img src="'. $thumbnail[0] .'" width="75" style="height:75" alt=""  class="video-thumb"/>'
		            : '';
...
if( !function_exists('tfuse_theme_styles') )
{
    function tfuse_theme_styles($values = array(),$options = array())
    {
        ...
        if(!empty($body_font))
        {
            switch ($body_font) {
                ...
                case 'questrial': 
                    ...
                    break;
                case 'raleway': 
                    $font = '//fonts.googleapis.com/css?family=Raleway';
        ...
        if(!empty($h_font))
        {
            switch ($h_font) {
                case 'roboto': 
                    $head_font = '//fonts.googleapis.com/css?family=Roboto+Slab:400,700';
                    $h_family ='"Roboto Slab", serif';
                    break;
                case 'cabin': 
                    $head_font = '//fonts.googleapis.com/css?family=Cabin';
                    $h_family ='"Cabin", sans-serif';
                    break;
                case 'droid_sans':
                    $head_font = '//fonts.googleapis.com/css?family=Droid+Sans';
                    $h_family ="'Droid Sans', sans-serif";
                    break;
                case 'gafata': 
                    $head_font = '//fonts.googleapis.com/css?family=Gafata|Lato:300,700';
                    $h_family = '"Gafata", sans-serif';
                    break;
                case 'oxygen':
                    $head_font = '//fonts.googleapis.com/css?family=Oxygen';
                    $h_family ="'Oxygen', sans-serif";
                    break;
                case 'philosopher': 
                    $head_font = '//fonts.googleapis.com/css?family=Philosopher';
                    $h_family ="'Philosopher', sans-serif";
                    break;
                case 'questrial': 
                    $head_font = '//fonts.googleapis.com/css?family=Questrial';
                    $h_family ="'Questrial', sans-serif";
                    break;
                case 'raleway': 
                    $head_font = '//fonts.googleapis.com/css?family=Raleway';
                    $h_family ="'Raleway', sans-serif";
                    break;
                case 'signika': 
                    $head_font = '//fonts.googleapis.com/css?family=Signika';
                    $h_family ="'Signika', sans-serif";
                    break;
                case 'ubuntu':
                    $head_font = '//fonts.googleapis.com/css?family=Ubuntu';
                ...
                case 'arial': 
                    ...
                    break;
                case 'arbutus': 
                    $head_font = '//fonts.googleapis.com/css?family=Arbutus+Slab';
                    $h_family ="'Arbutus Slab', serif";
                    break;
                case 'bitter': 
                    $head_font = '//fonts.googleapis.com/css?family=Bitter';
                    $h_family ="'Bitter', serif";
                    break;
                case 'coustard': 
                    $head_font = '//fonts.googleapis.com/css?family=Coustard';
                    $h_family ="'Coustard', serif";
                    break;
                case 'droid_serif': 
                    $head_font = '//fonts.googleapis.com/css?family=Droid+Serif';
                    $h_family ="'Droid Serif', serif";
                    break;
                case 'eb': 
                    $head_font = '//fonts.googleapis.com/css?family=EB+Garamond';
                    $h_family ="'EB Garamond', serif";
                    break;
                case 'goudy': 
                    $head_font = '//fonts.googleapis.com/css?family=Goudy+Bookletter+1911';
                    $h_family ="'Goudy Bookletter 1911', serif";
                    break;
                case 'kotta': 
                    $head_font = '//fonts.googleapis.com/css?family=Kotta+One';
                    $h_family ="'Kotta One', serif";
                    break;
                case 'playfair': 
                    $head_font = '//fonts.googleapis.com/css?family=Playfair+Display';
                    $h_family ="'Playfair Display', serif";
                    break;
                case 'vidaloka': 
                    $head_font = '//fonts.googleapis.com/css?family=Vidaloka';
