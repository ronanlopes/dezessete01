                ...
                array(
                    ...
                    'options' => array(/* 1 */
                        ...
                        array(
                            ...
                            'desc' => __('Upload a logo for your theme, or specify the image address of your online logo. (//yoursite.com/logo.png)','tfuse'),
                ...
                array(
                    ...
                    'options' => array(
                        array(
                            ...
                            'desc' => __('Set your' ,'tfuse').'<a href="//screencast.com/t/zHu17C7nXy1">'.__('twitter' ,'tfuse').'</a> '.__('application' ,'tfuse').' <a href="//screencast.com/t/yb44HiF2NZ">'.__('consumer key' ,'tfuse').'</a>.',
                        ...
                        array(
                            ...
                            'desc' => __('Set your ','tfuse').'<a href="//screencast.com/t/zHu17C7nXy1">'.__('twitter','tfuse').'</a> '.__('application','tfuse').' <a href="//screencast.com/t/eaKJHG1omN">'.__('consumer secret key' ,'tfuse').'</a>.',
                        ...
                        array(
                            ...
                            'desc' => __('Set your ','tfuse').'<a href="//screencast.com/t/zHu17C7nXy1">'.__('twitter','tfuse').'</a> '.__('application','tfuse').' <a href="//screencast.com/t/QEEG2O4H">'.__('access token key' ,'tfuse').'</a>.',
                        ...
                        array(
                            ...
                            'desc' => __('Set your ','tfuse').'<a href="//screencast.com/t/zHu17C7nXy1">'.__('twitter','tfuse').'</a>  '.__('application','tfuse').' <a href="//screencast.com/t/Yv7nwRGsz">'.__('access token secret key' ,'tfuse').'</a>.',
