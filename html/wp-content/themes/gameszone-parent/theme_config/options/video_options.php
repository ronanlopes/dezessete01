...
$options = array(
    ...
    array('name' => __('Video','tfuse'),
        'desc' => __('Copy paste the video URL or embed code. The video URL works only for Vimeo and YouTube videos. Read ','tfuse').'<a target="_blank" href="//www.no-margin-for-errors.com/projects/prettyphoto-jquery-lightbox-clone/">'.__('prettyPhoto documentation','tfuse').'</a> '.__('for more info on how to add video or flash in this text area','tfuse').'',
