...
$options = array(
    array('name' => __('Thumbs Type','tfuse'),
        'desc' => __('Select category thumbs type.','tfuse'),
        'id' => TF_THEME_PREFIX . '_gallery_type',
        'value' => '',
        'options' => array('med' => __('Medium Thumbs','tfuse'),'small' => __('Small Thumbs','tfuse')),
        'type' => 'select'
    ),
