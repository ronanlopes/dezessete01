...
class TF_OPTISAVE extends TF_TFUSE {
    ...
    function post_multi_upload( $option, &$post_options ) {
        $this->post_multi_upload2( $option, $post_options );
    }

    function admin_multi_upload( $option, $values, &$framework_options ) {
        $this->admin_multi_upload2( $option, $values, $framework_options );
    }

    function taxonomy_multi_upload( $option, $term_id, &$taxonomy_options ) {
        $this->taxonomy_multi_upload2( $option, $term_id, $taxonomy_options );
    }
